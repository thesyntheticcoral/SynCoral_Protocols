...
#Cumulative TA
cumu.data <- read.csv("/Users/hannahreich/Desktop/Github/SynCoral_Protocols/WaterQuality/20201009_OSA/Cumulative_TA_Output.csv", header=TRUE, sep=",")
update.data <- rbind(cumu.data, TA)

write.table(update.data,"/Users/hannahreich/Desktop/Github/SynCoral_Protocols/WaterQuality/20201009_OSA/Cumulative_TA_Output.csv",sep=",", row.names=FALSE)
