...
# HGR started script on 20201003
...
library(nlme) #version: 3.1-13-1 Date: 2017-02-06 Depends: R (>= 3.0.2) Imports: graphics, stats, utils, lattice
...
#############################################################
setwd("/Users/hannahreich/Desktop/Github/SynCoral_Protocols/WaterQuality/20200917/") #set working directory
#setwd("~/MyProjects/Intragenerational_thresholds_OA/RAnalysis/Data") #set working directory
mainDir<- "/Users/hannahreich/Desktop/Github/SynCoral_Protocols/WaterQuality/20200917/" #set main directory
...
path <-("/Users/hannahreich/Desktop/Github/SynCoral_Protocols/WaterQuality/20200917/pH_Calibration_Files/")
...
pdf("/Users/hannahreich/Desktop/Github/SynCoral_Protocols/WaterQuality/20200917/Daily_Treatment_Measures.pdf")
par(mfrow=c(2,2))
plot(SW.chem$Treatment, SW.chem$Temperature, xlab="Treatment", ylab="Temperature°C", ylim=c(6,30), las=2)
plot(SW.chem$Treatment, SW.chem$pH.Total, xlab="Treatment", ylab="pH Total Scale", ylim=c(6.0,9.2), las=2)
plot(SW.chem$Treatment, SW.chem$Salinity, xlab="Treatment", ylab="Salinity psu", ylim=c(20,40), las=2)
dev.off()

# dont need this part until experiment!
# pdf("~/MyProjects/Geoduck_Conditioning/RAnalysis/Output/Daily_Tank_Measures.pdf")
#pdf("/Users/hannahreich/Desktop/Github/TA/retomorrow/Daily_Treatment_Measures.pdf")
#par(mfrow=c(3,1))
...
SW.chem1 <- SW.chem[,c(1:12,14:16)]
SW.chem <- na.omit(SW.chem1) #remove NA
...
write.table(carb.output, "/Users/hannahreich/Desktop/Github/SynCoral_Protocols/WaterQuality/20200917/Seawater_chemistry_table_Output_All_holygrail.csv", sep=",", row.names = FALSE) #save data
...
# CHECK YOUR Y AXIS!
pdf("/Users/hannahreich/Desktop/Github/SynCoral_Protocols/WaterQuality/20200917/Treatment_Water_Chem_withTA.pdf")
par(mfrow=c(3,2))
...
pdf("/Users/hannahreich/Desktop/Github/SynCoral_Protocols/WaterQuality/20200917/Tank_Water_Chem_withTA.pdf")
par(mfrow=c(3,2))
