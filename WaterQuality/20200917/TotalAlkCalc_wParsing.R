...
setwd("/Users/hannahreich/Desktop/Github/")
...
#### pH Calibration #####
pHCal<-read.csv("/Users/hannahreich/Desktop/Github/SynCoral_Protocols/WaterQuality/20200917/pHCalibration.csv") # read in the pH Calibration file
...
#Cumulative TA
cumu.data <- read.csv("/Users/hannahreich/Desktop/Github/SynCoral_Protocols/WaterQuality/20200917/Cumulative_TA_Output.csv", header=TRUE, sep=",")
update.data <- rbind(cumu.data, TA)

write.table(update.data,"/Users/hannahreich/Desktop/Github/SynCoral_Protocols/WaterQuality/20200917/Cumulative_TA_Output.csv",sep=",", row.names=FALSE)
